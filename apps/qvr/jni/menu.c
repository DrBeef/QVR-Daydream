...
extern void jni_ControllerStrafeMode(int mode);
...
static void M_Menu_YawPitchControl_Key (int key, int ascii)
{
	...
	case K_LEFTARROW:
		...
		else if (controllermode_cursor == 2)
		{
			...
			jni_ControllerStrafeMode(cl_controllerstrafe.integer);
		}
...
static void M_Menu_YawPitchControl_Draw (void)
{
	...
	if (cl_controllermode.integer == 1)
		M_Options_PrintCommand(" Controller Mode:           Use Daydream Controller (default)", true);
	else if (cl_controllermode.integer == 0)
		M_Options_PrintCommand(" Controller Mode:           Do Not Use Daydream Controller", true);

	if (cl_controllerstrafe.integer == 1)
		M_Options_PrintCommand(" Daydream Controller Strafe: Enabled", (cl_controllermode.integer == 1));
	else if (cl_controllerstrafe.integer == 0)
		M_Options_PrintCommand(" Daydream Controller Strafe: Disabled", (cl_controllermode.integer == 1));
